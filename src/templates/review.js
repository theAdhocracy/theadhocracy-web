...
export default ({ data }) => {
	...
	return (
		<Layout title={review.title} meta={{ desc: `${review.desc} Rated ${review.rating} out of 5.`, type: "article", category: review.type, published: review.date, updated: review.updated }}>
